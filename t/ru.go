...
/tx_{{.ShortHash}} #tx`,
	...
	PAYMENTRECEIVED:      "Платёж получен: {{.Sats}}. /tx_{{.Hash}} #tx",
	...
	APPBALANCE: "#{{.App | lower}} Баланс: <i>{{.Balance}} sat</i>",
...
<code>/reveal 5c0b2rh4x</code> создаёт приглашение открыть скрытое сообщение 5c0b2rh4x, если оно существует.
	...
	MICROBETPLACING:             "#microbet Размещаем ставку на <b>{{.Bet.Description}} ({{if .Back}}back{else}}lay{{end}})</b>.",
