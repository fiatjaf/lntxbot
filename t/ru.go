...
/bitflash_orders показывает ваши предыдущие транзакции.
	...
	MICROBETPAIDBUTNOTCONFIRMED: "<b>[Microbet]</b> плачено, но не подтверждено. Крупная ошибка Microbet?",
	MICROBETPLACING:             "<b>[Microbet]</b> омещаем ставку на <b>{{.Bet.Description}} ({{if .Back}}back{else}}lay{{end}})</b>.",
	MICROBETPLACED:              "<b>[Microbet]</b> тавка размещена!",
	MICROBETLIST: `
