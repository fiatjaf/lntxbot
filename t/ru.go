...
Зарегистрировано: {{.Registered}}
	...
	START: `
⚡️ @lntxbot - кошелек Bitcoin Lightning в вашем Telegram.

🕹️ Основные команды
<b>&lt;invoice&gt;</b> - Просто вставьте счет или LNURL, чтобы расшифровать или оплатить его.
<b>/balance</b> - Показывает ваш баланс.
<b>/tip &lt;сумма&gt;</b> - Отправьте это в ответ на другое сообщение в группе, чтобы оставить чаевые.
<b>/invoice &lt;сумма&gt; &lt;описание&gt;</b> - Генерирует счет-фактуру Lightning: /invoice 400 'split coffee'.
<b>/send &lt;сумма&gt; &lt;пользователь&gt;</b> - Отправляет несколько сатоши другому пользователю: /send 100 @fiatjaf

🍎 Другие вещи, которые вы можете сделать
- Используйте <b>/send</b> для отправки денег на любой Lightning-адрес.
- Получайте деньги на kotyauditore@lntxbot.com или на https://lntxbot.com/@kotyauditore.
- Производить вычисления типа 4*usd или eur*rand() всякий раз, когда вы указываете сумму в сатоши.
- Используйте <b>/withdraw lnurl &lt;сумма&gt;</b>, чтобы создать LNURL-withdraw ваучер.

🎮 Веселые или полезные команды
<b>/sats4ads</b> Получайте деньги за получение спам-сообщений, вы контролируете их количество - или отправляйте рекламу всем подряд. Большие коэффициенты конверсии!
<b>/giveaway</b> и /giveflip - Раздавать деньги в группах!
...
<b>/coinflip &lt;сумма&gt; &lt;количество_участников&gt;</b> - Создает лотерею, в которой может принять участие любой желающий (стоит 10sat fee).

🐟 Встроенные команды - могут быть использованы в любом чате, даже если бот не присутствует в нем
@lntxbot give &lt;сумма&gt; - Создает кнопку в приватном чате для передачи денег другой стороне.
@lntxbot coinflip/giveflip/giveaway - То же самое, что и версия слэш-команды, но может использоваться в группах без @lntxbot.
@lntxbot invoice &lt;сумма&gt; - Выставляет счет и отправляет его в чат.
...
<b>/help &lt;команда&gt;</b> - Показывает подробную справку по определенной команде.
<b>/paynow &lt;счет&gt;</b> - Оплатить счет без запроса.
<b>/send --anonymous &lt;сумма&gt; &lt;пользователь&gt;</b> - Получатель не знает, кто отправил ему саты.

🏛 Групповое администрирование
<b>/toggle ticket &lt;сумма&gt;</b> - Выставить цену в сатоши за вступление в вашу группу. Отличный антиспам! Деньги идут владельцу группы.
<b>/toggle renamable &lt;сумма&gt;</b> - Позволяет людям использовать /rename для переименования вашей группы, и вы получаете деньги.
<b>/toggle expensive &lt;сумма&gt; &lt;regex pattern&gt;</b> - Взимать плату с людей за неправильные слова в вашей группе (или оставить пустым, чтобы взимать плату за все сообщения).
<b>/fine &lt;сумма&gt;</b> - заставить людей платить вам или быть выгнанными из группы.
